...
import { Folder, FolderOpen, Pin, Check, X } from 'lucide-react';
...
export function FolderCard({
    ...
    const handleConfirmRename = (isBlur = false) => {
        ...
        const isConflict = existingFolderNames.some(
            name => name.trim().toLowerCase() === trimmed.toLowerCase() && name.trim().toLowerCase() !== folder.name.trim().toLowerCase()
        );
