...
import { Disc, FolderOpen, Settings, Radio, Star, Clock, LayoutGrid, Moon, Sun } from 'lucide-react';
...
export function Sidebar({ className = '' }: SidebarProps) {
    ...
    return (
        <aside className={`w-[var(--sidebar-width)] h-screen bg-card border-r border-border flex flex-col flex-shrink-0 ${className}`}>
            {/* App Header */}
