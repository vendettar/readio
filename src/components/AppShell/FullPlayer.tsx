...
import { Play, Pause, SkipBack, SkipForward, Minimize2, Settings2 } from 'lucide-react';
import { usePlayerStore } from '../../store/playerStore';
import { useImmersionStore } from '../../store/immersionStore';
import { useZoom } from '../../hooks/useZoom';
import { formatTimeLabel, findSubtitleIndex } from '../../libs/subtitles';
            ...
            <div className="flex-1 flex overflow-hidden">
                ...
                <div className="w-96 hidden xl:flex flex-col items-center justify-center p-12 bg-muted/30 border-r border-border/50">
                    ...
                    <div className="text-center space-y-3 max-w-xs">
                        <h2 className="text-3xl font-bold text-foreground tracking-tight leading-tight">{audioTitle || t('untitled')}</h2>
                    </div>
                </div>
                ...
                <div className="flex-1 relative overflow-hidden">
                    ...
                    <div className="xl:hidden p-8 pb-0 text-center mb-8">
                        <div className="w-48 h-48 mx-auto shadow-xl rounded-xl overflow-hidden mb-6 bg-muted">
                            {coverArtUrl && <img src={coverArtUrl} className="w-full h-full object-cover" alt="" />}
                        </div>
                        <h2 className="text-2xl font-bold text-foreground mb-1">{audioTitle || t('untitled')}</h2>
                    </div>
            ...
            <div className="bg-background border-t border-border px-8 py-6 z-20">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="flex items-center gap-4 mb-6 group">
                        <span className="text-xs text-muted-foreground tabular-nums w-12 text-right font-medium">{formatTimeLabel(progress)}</span>
                        ...
                        <span className="text-xs text-muted-foreground tabular-nums w-12 font-medium">{formatTimeLabel(duration)}</span>
                    </div>
