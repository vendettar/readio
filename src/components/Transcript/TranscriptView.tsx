...
export function TranscriptView({
  ...
  const { state, copyText, searchWeb, lookupFromMenu, closeMenu, closeLookup } =
  ...
  return (
    <>
      ...
      <ContextMenu
        ...
        onClose={closeMenu}
      />
      <LookupPopover state={state} onClose={closeLookup} />
      <WordHoverOverlay rects={state.hoverRects} isPressed={state.showLookup} />
    </>
  )
}
