...
export function InteractiveTitle({
    ...
    if (onClick) {
        return (
            ...
            >
                <span className={cn(clampClass, "overflow-hidden hover:underline decoration-primary/30 underline-offset-4 transition-all")}>
                    {title}
                </span>
            </Button>
        );
    ...
    return (
        ...
        >
            <span className={cn(clampClass, "overflow-hidden transition-all")}>
                {title}
            </span>
        </span>
    );
