...
import { Play, MoreHorizontal, Info, Link as LinkIcon, Star, RadioTower } from 'lucide-react';
        ...
        return (
            <div className="flex gap-4 overflow-hidden py-2">
                {Array.from({ length: visibleCount || 3 }).map((_, colIndex) => (
                    <div key={colIndex} className="flex-shrink-0 flex flex-col gap-4 w-[var(--column-width)]" style={{ '--column-width': `${CAROUSEL_DEFAULTS.GRID_MIN_ITEM_WIDTH}px` } as React.CSSProperties}>
                ...
                {Array.from({ length: totalColumns }).map((_, colIndex) => (
                    ...
                    >
                        {Array.from({ length: ROWS }).map((_, rowIndex) => {
                            ...
                            const favorited = favoritedIds.has(episode.id) || (episode.url ? favoriteAudioUrls.has(episode.url) : false);
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="absolute right-0 inset-y-0 flex opacity-0 group-hover/item:opacity-100 transition-opacity duration-200 z-30">
                                        {/* Gradient fade */}
                                            ...
                                            >
                                                <DropdownMenuTrigger asChild>
                                                    <Button
                                                        ...
                                                        className="w-8 h-8 text-muted-foreground hover:text-primary transition-colors hover:bg-transparent"
                                                    >
