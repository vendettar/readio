...
import { type Episode, type Podcast } from '../../libs/discoveryProvider';
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <Button
                                        variant="ghost"
                                        size="icon"
                                        className="w-8 h-8 text-primary hover:bg-transparent hover:opacity-80 transition-opacity duration-200 relative z-20"
