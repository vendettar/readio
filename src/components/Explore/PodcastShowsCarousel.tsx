...
export function PodcastShowsCarousel({ podcasts, isLoading, onPlayLatest, onSubscribe }: TopShowsCarouselProps) {
    const {
        scrollRef,
        visibleCount,
        canScrollLeft,
            ...
            <div className="flex gap-4 overflow-hidden py-1">
                {Array.from({ length: skeletonCount }).map((_, i) => (
                    <div
                        ...
                        style={{ '--item-width': `${CAROUSEL_DEFAULTS.MAX_ITEM_WIDTH}px` } as React.CSSProperties}
                    >
