...
export function useCarouselLayout(
    ...
    const { gap, rows, minItemWidth, maxItemWidth, fixedModeBreakpoint, maxVisibleItems, minVisibleItems } = mergedConfig;
    ...
    }, [gap, rows, minItemWidth, maxItemWidth, maxVisibleItems, minVisibleItems]);
    ...
    }, [itemCount, calculateItemWidth, updateScrollButtons]);
