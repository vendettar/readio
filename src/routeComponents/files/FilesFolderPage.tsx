...
import { Home, Upload, FileAudio } from 'lucide-react';
import { DndContext, DragOverlay, useDroppable, type Modifier } from '@dnd-kit/core';
import { useKeyboardShortcuts } from '../../hooks/useKeyboardShortcuts';
import { useI18n } from '../../hooks/useI18n';
import { useFileProcessing } from '../../hooks/useFileProcessing';
import { useFileDragDrop } from '../../hooks/useFileDragDrop';
import { DB, type FileTrack, type FileSubtitle, type FileFolder } from '../../libs/dexieDb';
...
function FolderDropTarget({ folderId, children }: {
    folderId: number;
    ...
    return (
        <div
            ...
            data-droppable="true"
            className={cn(
                'folder-drop-target min-h-48 rounded-xl transition-colors duration-150'
            )}
        >
            {children}
        </div>
...
export default function FilesFolderPage() {
    ...
    const handleDragEnd = useCallback((event: Parameters<typeof originalHandleDragEnd>[0]) => {
