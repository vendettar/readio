...
import { lookupPodcastFull, fetchPodcastFeed, type Episode } from '../../libs/discoveryProvider';
        ...
        <div className="h-full overflow-y-auto bg-background text-foreground custom-scrollbar">
            ...
            >
                ...
                <div className="flex flex-col">
                    ...
                    {/* Limited Feed Notice */}
                    {!hasMore && episodes.length > 0 && podcast?.trackCount && episodes.length < podcast.trackCount * 0.8 && (podcast.trackCount - episodes.length > 20) && (
