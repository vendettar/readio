            ...
            >
                {subtitlesLoaded ? (
                    ...
                    <div className="h-full flex flex-col items-center justify-center p-12 text-center opacity-60">
                        ...
                        <p className="text-lg font-bold text-foreground tracking-tight mb-2">{t('homeNoSubtitles')}</p>
                        <p className="text-sm text-muted-foreground max-w-sm mx-auto">{t('homeNoSubtitlesDesc')}</p>
                    </div>
                ) : (
                    <div className="h-full flex flex-col items-center justify-center p-12 text-center opacity-60">
                        <div className="w-16 h-16 mb-6 rounded-full bg-muted flex items-center justify-center">
                        ...
                        <p className="text-lg font-bold text-foreground tracking-tight mb-2">{t('homeSessionFound')}</p>
                        <p className="text-sm text-muted-foreground max-w-sm mx-auto mb-4">{t('homeSessionInterrupted')}</p>
                        <Button asChild className="rounded-lg">
                            <Link to="/files">
                                {t('homeContinueUpload')}
                            </Link>
                        </Button>
                    </div>
                )}
