...
describe('recommendation algorithm - pure functions', () => {
            ...
            const groups: RecommendedGroup[] = [
                {
                    ...
                    term: 'technology',
                    items: [
                        { id: '1', title: 'P1', author: 'A', artworkUrl: '', feedUrl: 'HTTP://FEED1.COM', genreNames: [] },
                        { id: '2', title: 'P2', author: 'A', artworkUrl: '', feedUrl: 'http://feed2.com', genreNames: [] },
                    ]
                }
            ];
    ...
    describe('filterCandidatesByGenre', () => {
        const candidates: RecommendedPodcast[] = [
            { id: '1', title: 'Tech Pod', author: 'A', artworkUrl: '', feedUrl: '', genreNames: ['Technology', 'Business'] },
            { id: '2', title: 'Biz Pod', author: 'A', artworkUrl: '', feedUrl: '', genreNames: ['Business'] },
            { id: '3', title: 'Sci Pod', author: 'A', artworkUrl: '', feedUrl: '', genreNames: ['Science'] },
        ];
    ...
    describe('deduplicateByFeed', () => {
        const podcasts: RecommendedPodcast[] = [
            { id: '1', title: 'P1', author: 'A', artworkUrl: '', feedUrl: 'http://feed1.com', genreNames: [] },
            { id: '2', title: 'P2', author: 'A', artworkUrl: '', feedUrl: 'HTTP://FEED1.COM', genreNames: [] }, // Duplicate
            { id: '3', title: 'P3', author: 'A', artworkUrl: '', feedUrl: 'http://feed2.com', genreNames: [] },
        ];
    ...
    describe('getShuffledGenresForDate', () => {
        const pool: RecommendedPodcast[] = [
            { id: '1', title: 'P1', author: 'A', artworkUrl: '', feedUrl: '', genreNames: ['Technology', 'Business'] },
            { id: '2', title: 'P2', author: 'A', artworkUrl: '', feedUrl: '', genreNames: ['Science', 'Technology'] },
