...
CLOUD_RUNTIME_OPTIONAL_SECRET_VARS := \
...
CLOUD_RUNTIME_OPTIONAL_NON_SECRET_VARS := \
	...
	READIO_HOST_METRICS_INTERVAL_SECONDS
CLOUD_BROWSER_PUBLIC_VARS := \
	READIO_ASR_RELAY_PUBLIC_TOKEN
CLOUD_OPTIONAL_BROWSER_PUBLIC_VARS := \
...
export $(CLOUD_RUNTIME_OPTIONAL_SECRET_VARS)
export $(CLOUD_RUNTIME_NON_SECRET_VARS)
export $(CLOUD_RUNTIME_OPTIONAL_NON_SECRET_VARS)
export $(CLOUD_BROWSER_PUBLIC_VARS)
export $(CLOUD_OPTIONAL_BROWSER_PUBLIC_VARS)
