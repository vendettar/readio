  ...
  return (
    ...
    >
      ...
      */}
      <div
        className={cn(
          'absolute inset-y-0 -start-page-gutter end-0 rounded-lg bg-accent/50 opacity-0 group-hover/episode:opacity-100 transition-opacity duration-300 pointer-events-none'
        )}
      />
      ...
      <div className="relative flex items-center gap-4 py-3">
        ...
        <div className="flex-1 min-w-0 flex items-center justify-between">
          <div className="flex-1 min-w-0 pe-12 py-1">
            ...
            <div className="mb-0.5 relative">{title}</div>
          ...
          <div className="flex items-center flex-shrink-0 gap-6">
            {meta && (
              <span className="text-xs text-muted-foreground font-medium whitespace-nowrap min-w-20 w-fit text-start">
                {meta}
              </span>
            )}
      ...
      {showDivider && (
        <div
          className={cn(
            'absolute bottom-0 start-0 end-4 h-px bg-border/50 transition-opacity duration-200 smart-divider smart-divider-bottom',
