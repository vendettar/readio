...
>(({ className, sideOffset = 4, onMouseDown, onClick, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-menu min-w-32 overflow-hidden rounded-xl border border-border/50 bg-popover/95 backdrop-blur-xl backdrop-saturate-150 p-0 text-popover-foreground shadow-2xl',
