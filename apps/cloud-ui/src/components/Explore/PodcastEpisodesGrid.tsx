...
import { buildPodcastEpisodeRoute, normalizeCountryParam } from '../../lib/routes/podcastRoutes'
            ...
            <AnimatedList
              ...
              renderItem={(episode, rowIndex) => {
                ...
                const episodeRoute = buildPodcastEpisodeRoute({
                  ...
                  podcastId,
                  episodeSlug: generateSlugWithId(episode.name, episode.id),
                })
