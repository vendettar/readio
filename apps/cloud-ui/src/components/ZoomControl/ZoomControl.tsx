...
export function ZoomControl({
  ...
  return (
    <div
      className="fixed bottom-24 end-8 z-overlay flex items-center gap-2 p-1 bg-popover/80 backdrop-blur-md border rounded-full shadow-lg animate-in fade-in slide-in-from-inline-end-4"
