...
import { completeSelectionSurfaceClose } from './selectionSurfaceRuntime'
...
export function useSelectionActions(
  ...
  const prepareInteraction = useCallback(
    () =>
      prepareSelectionInteraction({
        interactionSequenceRef,
        wasPlayingBeforeInteractionRef,
      }),
    []
  )
    ...
    (options?: { reason?: 'dismiss' | 'switch' }) => {
      completeSelectionSurfaceClose({
        refs: {
          abortRef,
          activeSurfaceIdRef,
          activeSurfaceTypeRef,
          pendingLookupHighlightWordRef,
        },
        setState,
        cancelInteraction,
        options,
  ...
  const closeLookup = useCallback(
    (options?: {
      ...
      completeSelectionSurfaceClose({
        ...
        setState,
        cancelInteraction,
        options: options ?? { surface: 'lookup' },
