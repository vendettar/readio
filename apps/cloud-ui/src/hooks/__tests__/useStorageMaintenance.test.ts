...
const {
  ...
  clearRecommendedMemoryCacheMock,
  ...
  clearRecommendedMemoryCacheMock: vi.fn(),
...
vi.mock('../../lib/recommended/cache', () => ({
  clearRecommendedMemoryCache: clearRecommendedMemoryCacheMock,
}))
