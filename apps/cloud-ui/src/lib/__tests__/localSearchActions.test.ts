  ...
  it('navigates favorite result to canonical episode detail instead of direct play', async () => {
    ...
    expect(deps.navigate).toHaveBeenCalledWith({
      ...
      params: {
        country: 'us',
        id: '123',
        episodeId: generateSlugWithId('Episode Title', 'episode-guid-123'),
      },
    })
  ...
  it('navigates history explore result to canonical episode detail when metadata exists', async () => {
    ...
    const result = {
      ...
      data: {
        ...
        providerEpisodeId: 'provider-episode-456',
    ...
    expect(deps.navigate).toHaveBeenCalledWith({
      ...
      params: {
        country: 'jp',
        id: '456',
        episodeId: generateSlugWithId('History Episode', 'provider-episode-456'),
      },
    })
    expect(deps.play).not.toHaveBeenCalled()
  })
