...
export function GutterPlayButton({ onPlay, ariaLabel }: GutterPlayButtonProps) {
  return (
    <div className="absolute -start-page-gutter top-0 bottom-0 w-page-gutter flex items-center justify-center opacity-0 group-hover/episode:opacity-100 group-focus-within/episode:opacity-100 transition-opacity duration-200">
      <Button
        variant="ghost"
        size="icon"
        onClick={(e) => {
