import { getCorsProxyConfig } from '../networking/proxyUrl'
...
async function readResponseText(response: Response): Promise<string> {
  ...
  throw new Error('Dictionary response is not readable')
}
...
function buildProxyAuthHeaders(authHeader: string, authValue: string): Record<string, string> {
  if (!authValue || !authHeader) return {}
