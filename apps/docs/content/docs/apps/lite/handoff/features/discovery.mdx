...
- Provide a clear Offline badge in the sidebar/header.
- **Local Entry**: Keep a visible "Local Library" entry point (Subscriptions/Favorites/History/Files) so users have actionable offline content.
