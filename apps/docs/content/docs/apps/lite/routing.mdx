...
| Podcast | `/podcast/$id` | Podcast Show page. `$id` is the Provider ID (e.g. iTunes ID). Supports `?fromLayoutPrefix` for context-aware transitions. |
...
- **Legal Routes**: `/legal/privacy` and `/legal/terms` (Instruction 039).
