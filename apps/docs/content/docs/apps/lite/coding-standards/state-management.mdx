...
- **Zustand & Persistence**:
  ...
  - **High-Frequency Fields**: Do NOT subscribe to entire stores when fields update frequently (e.g., progress/time/scroll/drag). Use atomic selectors or `useShallow` for multi-select.
