...
## D032 — Robust Metadata Parser
- **Decision**: Use `music-metadata-browser` for ID3 parsing in a Worker.
- **Rationale**: Reduce parsing errors and keep the main thread responsive.
