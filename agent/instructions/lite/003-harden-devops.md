...
---
## Documentation
- Update `apps/docs/content/docs/apps/lite/handoff/environment.mdx` (tooling + scripts).
- Update `apps/docs/content/docs/general/monorepo-strategy.mdx` if engine policy changes.
