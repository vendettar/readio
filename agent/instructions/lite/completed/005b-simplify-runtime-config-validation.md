...
# Patch: 005b-simplify-runtime-config-validation
...
- Add Zod coercion tests for `public/env.js` overrides.
- Runtime config must not be frozen at module load; re-evaluate on env change.
