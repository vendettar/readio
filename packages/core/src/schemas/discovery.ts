...
export const PodcastSchema = z.object({
  providerPodcastId: z.number().int().positive().optional(),
...
export const SearchEpisodeSchema = z.object({
  providerEpisodeId: z.number().int().positive().optional(), // Was trackId
  providerPodcastId: z.number().int().positive().optional(), // Was collectionId
  trackName: z.string(),
